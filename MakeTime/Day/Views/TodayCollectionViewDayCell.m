...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
   ...
   for (EKEvent *ekEvent in self.customEvents) {
      if ([ekEvent.endDate isEqualToDate:eventComponent.endDate]) {
            ...
            EventComponents *newEventComponent = [EventComponents eventWithTitle:@""
                                                                        ...
                                                                        startDate:everyTwoHourDate
                                                                         endDate:eventComponent.endDate
                                                                           color:[UIColor colorWithCGColor:eventComponent.calendar.CGColor]];
...
- (void)loadConvertedEventComponents {
   ...
   // Scroll content view down to the 8AM view
   [self.collectionView setContentOffset:CGPointMake(0, 60.0 * 4) animated:NO];
}

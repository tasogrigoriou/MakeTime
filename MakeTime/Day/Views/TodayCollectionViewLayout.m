...
- (CGSize)collectionViewContentSize {
   // Return a width equal to two hour, and a height equal to the number of hours (12) multiplied by the height of a supplementary view representing two hours.
   return CGSizeMake(self.collectionView.bounds.size.width, TwoHoursViewHeight * 12);
}

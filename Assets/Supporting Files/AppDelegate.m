...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
   ...
   TodayViewController *frontVC = [TodayViewController new];
   RearViewController *rearVC = [RearViewController new];
   
   UINavigationController *frontNavController = [[UINavigationController alloc]
                                                 initWithRootViewController:frontVC];
   UINavigationController *rearNavController = [[UINavigationController alloc]
                                                initWithRootViewController:rearVC];
   
   SWRevealViewController *revealVC = [[SWRevealViewController alloc]
                                       initWithRearViewController:rearNavController
                                       frontViewController:frontNavController];
